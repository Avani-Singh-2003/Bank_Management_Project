...
public class signupthree extends JFrame implements ActionListener {
    ...
    signupthree(String formno) {
        ...
        JLabel pcarddetails = new JLabel("Your 4 digit Password");
        pcarddetails.setFont(new Font("Raleway", Font.BOLD, 12));
        pcarddetails.setBounds(100, 340, 300, 20);
        add(pcarddetails);
        ...
        c7 = new JCheckBox(
                "I hereby declares that the above entered details are connected to the best of my knowledge");
